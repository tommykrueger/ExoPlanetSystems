...
<?php echo $this->Form->create('Phlplanet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Phlplanet'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Phlplanet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Phlplanet.id'))); ?></li>
